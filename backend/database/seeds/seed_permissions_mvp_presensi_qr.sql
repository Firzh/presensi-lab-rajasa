...
INSERT INTO `permissions` (`perm_slug`, `module_name`, `action_name`, `keterangan`) VALUES
  ...
  ('attendance.manual.read', 'attendance_manual', 'read', 'Melihat data presensi untuk koreksi manual.'),
  ('attendance.manual.update', 'attendance_manual', 'update', 'Mengubah status presensi manual.'),
  ('attendance.manual.audit.read', 'attendance_manual', 'read', 'Melihat audit edit presensi manual.'),
  ('attendance.edit_reasons.read', 'attendance_manual', 'read', 'Melihat daftar alasan edit presensi.'),
...
WHERE r.`role_slug` = 'super_admin'
  AND p.`perm_slug` IN (
    ...
    'attendance.session.create', 'attendance.session.update', 'attendance.session.manage', 'attendance.manual.read', 'attendance.manual.update', 'attendance.manual.audit.read', 'attendance.edit_reasons.read',
    'attendance.warning.read', 'attendance.warning.review', 'attendance.warning.manage', 'attendance.log.read',
...
WHERE r.`role_slug` = 'guru'
  AND p.`perm_slug` IN (
    ...
    'attendance.session.read', 'attendance.session.create', 'attendance.session.update',
    'attendance.manual.read', 'attendance.manual.update', 'attendance.edit_reasons.read',
    'attendance.warning.read', 'attendance.warning.review', 'attendance.log.read',
...
WHERE r.`role_slug` = 'staff'
  AND p.`perm_slug` IN (
    ...
    'attendance.session.read', 'attendance.session.create', 'attendance.session.update',
    'attendance.manual.read', 'attendance.manual.update', 'attendance.edit_reasons.read',
    'attendance.warning.read', 'attendance.warning.review', 'attendance.log.read', 'reports.read',
    'reports.attendance.read', 'reports.attendance.export', 'reports.warning.read', 'reports.warning.export', 'notifications.read'
  )
ON DUPLICATE KEY UPDATE
  `is_allowed` = VALUES(`is_allowed`);
